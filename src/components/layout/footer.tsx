    ...
    <footer className="no-print mt-auto border-t border-primary/10">
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        <div className="flex flex-col gap-3 text-xs text-muted-foreground">
          ...
          <div className="mt-3 flex items-center justify-center gap-3 border-t border-border/50 pt-4">
            <a
              href="https://github.com/fe-m-bueno/rescisao-clt"
              target="_blank"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-heading text-sm font-semibold text-foreground/70 transition-colors hover:text-primary"
            >
              Felipe Bueno
            </a>
          </div>
